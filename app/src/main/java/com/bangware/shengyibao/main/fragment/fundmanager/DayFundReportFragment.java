...
public class DayFundReportFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null){
            view = inflater.inflate(R.layout.day_funk_report_fragment, container,
                    false);
        }
        if(view!=null)
        {
...
//      mLegend.setForm(LegendForm.LINE);  //设置比例图的形状，默认是方形
    ...
    private PieData getPieData(int count, float range) {
        ...
        colors.add(Color.rgb(115, 189, 224));
        colors.add(Color.rgb(256, 124, 125));
        colors.add(Color.rgb(58, 136, 210));
