...
public class WeekFundReportFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null){
            view = inflater.inflate(R.layout.week_funk_report_fragment, container,
                    false);
        }
        if(view!=null)
        {
    ...
    private void init(){
        mPieChart = (PieChart) getView().findViewById(R.id.weekfunkpieChart);
        lv = (ListView) getView().findViewById(R.id.weekfundListview);
    ...
    private ArrayList<FunkBean> getData() {
        ...
        for (int i = 0; i < 10; i++){
            ...
            funkBean.setPayName("支付宝");
            funkBean.setPayMoney("888.00万");
            list.add(funkBean);
        }
        return list;
    }
