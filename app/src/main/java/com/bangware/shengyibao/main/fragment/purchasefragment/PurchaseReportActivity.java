 ...
 * 采购报表
 */
public class PurchaseReportActivity extends FragmentActivity {
     ...
     * 切换的Fragment页面
     */
    private DayReportFragment mDayReportFg;
    private WeekReportFragment mWeekReportFg;
    private MonthReportFragment mMonthReportFg;
    /**
     * Tab显示内容TextView
     */
    ...
    private void init(){
        ...
        mBackIv = (ImageView) findViewById(R.id.id_purchaseRt_imageview);

        mDayReportFg = new DayReportFragment();
        mFragmentList.add(mDayReportFg);

        mWeekReportFg = new WeekReportFragment();
        mFragmentList.add(mWeekReportFg);

        mMonthReportFg = new MonthReportFragment();
