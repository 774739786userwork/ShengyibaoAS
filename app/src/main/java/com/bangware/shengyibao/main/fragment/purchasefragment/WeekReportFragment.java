...
public class WeekReportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null){
            view = inflater.inflate(R.layout.week_report_fragment, container,
                    false);
        }
        if(view!=null)
        {
    ...
    private void findViews(){
        mPieChart = (PieChart) getView().findViewById(R.id.weekpieChart);
    }
...
//      mChart.setOnAnimationListener(this);
        ...
        pieChart.setCenterText("各产品采购对比 2017");  //饼状图中间的文字
