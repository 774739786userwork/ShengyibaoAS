package com.bangware.shengyibao.main.fragment.salerreportmanager;
...
public class SalerReportActivity extends AppCompatActivity {
    ...
    private void findViews(){
        ...
        ImageView ivBack = (ImageView) findViewById(R.id.saler_back_iv);
    ...
    private void initLineData(){
        ...
        LineDataSet dataSet = new LineDataSet(yValue, "销售额");
        ...
        LineDataSet dataSet1 = new LineDataSet(yValue1, "销售量");
